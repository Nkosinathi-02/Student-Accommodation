            ...
            using (var stream = new MemoryStream())
            {
                using (var document = new Document())
                {
                    using (var writer = PdfWriter.GetInstance(document, stream))
                    {
                        ...
                        document.Add(new Paragraph($" "));
                        document.Add(new Paragraph($"For any queries you will need to get in touch by contacting our assistance realeboha@gmail.com or dial this number 0767319073."));
                        document.Add(new Paragraph($" ")); document.Add(new Paragraph($" "));
                        document.Add(new Paragraph($" Best Regards"));
                        document.Add(new Paragraph($"N Mdawonde"));
                        document.Close();
                    }
                }
